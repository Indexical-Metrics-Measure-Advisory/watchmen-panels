...
const GlobalStyle = createGlobalStyle<{ theme: Theme }>`
	*, *:before, *:after {
	...
	html {
		...
		--toggle-positive-slider-color: ${({ theme }) => theme.togglePositiveSliderColor};
		...
		--console-danger-shadow: ${({ theme }) => theme.consoleDangerShadow};
		--console-danger-hover-shadow: ${({ theme }) => theme.consoleDangerHoverShadow};
		--console-success-shadow: ${({ theme }) => theme.consoleSuccessShadow};
		--console-success-hover-shadow: ${({ theme }) => theme.consoleSuccessHoverShadow};
		...
		--console-favorite-shadow: ${({ theme }) => theme.consoleFavoriteShadow};
		--console-favorite-hover-shadow: ${({ theme }) => theme.consoleFavoriteHoverShadow};
